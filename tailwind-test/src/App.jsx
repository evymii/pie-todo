...
const App = () => {
  ...
  return (
    <div className="flex justify-center w-screen h-screen bg-gray-300/50">
      <div className=" flex flex-col items-center justify-start bg-[#FFFFFF] shadow-md w-[400px] h-[500px] rounded-lg ">
        <div
          id="Main-co"
          className="flex flex-col  w-[345px] h-[500px] rounded-md py-[26px] px-[16px] items-start justify-start  gap-2"
        >
          ...
          <div className="flex gap-2">
            <Button isSmall={true} text="All" handleClick={clearFilter} />
            <Button
              isSmall={true}
              text="Active"
              isGray={true}
          ...
          {/* <button className="flex text-white bg-blue-500 w-fit justify-center items-center rounded-lg border-[1px] border-blue-600 px-3 py-1 ">
              Add
            </button>
          </div>
          <div id="Filter" className="flex gap-2 ">
